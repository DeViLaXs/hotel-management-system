...
namespace HotelReservation {
    ...
    public partial class CustomersDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string Contact, string Email, System.DateTime DateOfBirth) {
...
namespace HotelReservation.CustomersDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Or" +
                "iginal_FirstName) AND ([LastName] = @Original_LastName) AND ([Contact] = @Origin" +
                "al_Contact) AND ([Email] = @Original_Email) AND ([DateOfBirth] = @Original_DateO" +
                "fBirth))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([FirstName], [LastName], [Contact], [Email], [DateOfBirth]) VALUES (@FirstName, @LastName, @Contact, @Email, @DateOfBirth);
SELECT Id, FirstName, LastName, Contact, Email, DateOfBirth FROM Customers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Contact] = @Contact, [Email] = @Email, [DateOfBirth] = @DateOfBirth WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Contact] = @Original_Contact) AND ([Email] = @Original_Email) AND ([DateOfBirth] = @Original_DateOfBirth));
SELECT Id, FirstName, LastName, Contact, Email, DateOfBirth FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HotelReservation.Properties.Settings.Default.CustomersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Contact, Email, DateOfBirth FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Contact, string Original_Email, System.DateTime Original_DateOfBirth) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Contact, string Email, System.DateTime DateOfBirth) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Contact, string Email, System.DateTime DateOfBirth, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Contact, string Original_Email, System.DateTime Original_DateOfBirth, int Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Contact, string Email, System.DateTime DateOfBirth, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Contact, string Original_Email, System.DateTime Original_DateOfBirth) {
            return this.Update(FirstName, LastName, Contact, Email, DateOfBirth, Original_Id, Original_FirstName, Original_LastName, Original_Contact, Original_Email, Original_DateOfBirth, Original_Id);
        }
    }
